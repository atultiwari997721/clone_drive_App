...
export default function DriverDashboard() {
  ...
  useEffect(() => {
    ...
    socket.on('new_ride_available', (ride: any) => {
  ...
  }, [isOnline]); // Re-attach if online status changes
  ...
  const acceptRide = () => {
      ...
      socket.emit('accept_ride', {
          ...
          driverLocation: { lat: 18.9900, lng: 73.1200 }
      });
  ...
  return (
    <div className="flex h-screen bg-gray-100 relative">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[500] bg-white px-6 py-3 rounded-full shadow-lg flex items-center gap-4">
      ...
      {rideRequest && (
        <div className="absolute bottom-4 left-4 right-4 z-[500] animate-in slide-in-from-bottom-5 duration-500">
